...
const Manager = () => {
    ...
    // Array of objects containing our menu items data
    const menuItems = [
                ...
                <div className={'w-[50%] h-full flex flex-col justify-between'}>
                        ...
                        <div>
                            <div className="mt-[20px]">
                                ...
                                <Button onClick = {toSalesReport}>Generate Sales Report</Button>
                            </div>
                        </Panel>
                </div>
                <div className={'w-[50%] ml-[20px] h-full flex flex-col justify-between'}>
                        ...
                        <div>
                            <div className="mt-[20px]">
                                ...
                                <Button onClick = {toExcessReport}>Generate Excess Report</Button>
                            </div>
                        </Panel>
                </div>
            </div>
                ...
                <div className={'w-[50%] mr-[20px] h-full flex flex-col justify-between'}>
                    ...
                    <Panel className="h-[48%]" title="Best Combo Report">
                        ...
                        */}
                        ...
                        <Button onClick = {toBestSellersReport}>Generate Best Sellers Report</Button>
                ...
                <div className={'w-[50%] h-full flex flex-col justify-between'}>
                        ...
                        <div>
                            <div className="mt-[20px]">
                                ...
                                <Button onClick = {toRestockReport}>Generate Restock Report</Button>
                            </div>
                        </Panel>
                </div>
                <div className={'w-[50%] h-full flex flex-col justify-between'}>
